    ...
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          {/* Section 2 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">2. Batasan Tanggung Jawab</h2>
            <div className="space-y-3 text-sm text-slate-600">
              <p>
          ...
          {/* Section 3 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">3. Hak Kekayaan Intelektual</h2>
            <div className="space-y-3 text-sm text-slate-600">
          ...
          {/* Section 4 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">4. Larangan Penggunaan</h2>
            <div className="space-y-3 text-sm text-slate-600">
          ...
          {/* Section 5 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">5. Paket Berlangganan dan Pembayaran</h2>
            <div className="space-y-3 text-sm text-slate-600">
              <ul className="list-disc pl-5 space-y-1">
          ...
          {/* Section 6 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">6. Pembatasan Layanan</h2>
            <div className="space-y-3 text-sm text-slate-600">
              <ul className="list-disc pl-5 space-y-1">
          ...
          {/* Section 7 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">7. Privasi dan Cookie</h2>
            <div className="space-y-3 text-sm text-slate-600">
          ...
          {/* Section 8 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">8. Hukum yang Berlaku</h2>
            <div className="space-y-3 text-sm text-slate-600">
          ...
          {/* Section 9 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">9. Perubahan Syarat</h2>
            <div className="space-y-3 text-sm text-slate-600">
          ...
          {/* Section 10 */}
          <section>
            <h2 className="text-xl font-semibold text-slate-800 mb-3">10. Kontak</h2>
            <div className="space-y-3 text-sm text-slate-600">
