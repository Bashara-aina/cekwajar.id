// ══════════════════════════════════════════════════════════════════════════════
// cekwajar.id — VerdictMockup Component
// Static mockup showing a "you found money" verdict with blurred gate
// ══════════════════════════════════════════════════════════════════════════════
          ...
          <div className="flex-1">
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li className="flex items-center justify-between gap-2 rounded bg-white/70 p-2">
                ...
                <span className="font-mono text-slate-500 blur-[2px] select-none">+ IDR ███.███</span>
              </li>
            </ul>

            <Badge className="mt-4 bg-primary-600 text-white">Buka detail · IDR 49.000</Badge>
          </div>
        </div>
      </CardContent>
    </Card>
