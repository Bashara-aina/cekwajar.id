      ...
      <div className="flex gap-2">
        {accentOptions.map((opt) => (
          <button
            ...
            title={opt.label}
            className={cn(
              'flex h-11 w-11 min-w-[44px] min-h-[44px] items-center justify-center rounded-full transition-all duration-150',
              'hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-emerald-500',
              opt.className,
