...
type OCRSource = 'google_vision' | 'tesseract' | 'tesseract_client' | 'openrouter'
      ...
      <Card className="border-dashed border-2 border-slate-300 bg-slate-50">
        <CardContent className="flex flex-col items-center justify-center py-12 px-6">
          ...
          >
            ...
            <div className="mt-5 flex w-full items-center gap-3 text-xs text-slate-500">
    ...
    return (
      <Card className="border-dashed border-2 border-slate-300 bg-slate-50">
        <CardContent className="flex flex-col items-center justify-center py-12 px-6">
          ...
          <p className="mt-1 text-sm text-slate-500">Menyimpan ke storage...</p>
        </CardContent>
      </Card>
    )
  }
