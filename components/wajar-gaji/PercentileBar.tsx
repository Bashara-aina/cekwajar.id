...
export function PercentileBar({ p25, p50, p75, userSalary, label = 'Gajimu' }: PercentileBarProps) {
  ...
  return (
    <figure role="img" aria-label={`Persentil gaji untuk ${label} - Gajimu berada di persentil ${percentile}`}>
      ...
      <figcaption className="sr-only">
        ...
        {zoneLabel}. Gajimu lebih tinggi dari {percentile}% karyawan dengan posisi & kota yang sama.
      </figcaption>
    </figure>
  )
}
